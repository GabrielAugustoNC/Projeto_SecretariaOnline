        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href = "verServicos.php" class = "btn btn-block btn-warning"><font size="3" color="White">Ver Serviços Cadastrados</font></a>
                    </div>

                    <br>

                    <div class="col-md-6">
                        <a href = "solicitarServ.php" class="btn btn-block btn-danger btn-sm"><font size="3" color="White">Solicitar Serviço</font></a>
                    </div>
