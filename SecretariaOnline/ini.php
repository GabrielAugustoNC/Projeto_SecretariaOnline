  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-left">
        <form method="POST" action="classeAcesso.php">
          <div class="form-group">
            <div class="col-sm-2">
              <font color="white">
                <label for="inputEmail3" class="control-label">RA</label>
              </font>
            </div>
            <div class="col-sm-10">
              <input type="text" name="ra" maxlength="8" class="form-control" id="inputEmail3" placeholder="RA">
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-2">
                ...
                <tbody>
                  <tr>
                    <td align="left" style="width:200px;">
                      <a type="submit" class="btn btn-warning" href="cadastro.php">Cadastre-se</a>
                    </td>
